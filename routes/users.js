...
function createUser(req, res, next){
  ...
  client.query('INSERT INTO notifymeusers (username, password) VALUES($1, $2)', [req.body.username, pwd], function(err, result) {
    if (err) {
...
router.post('/signup', function(req, res, next) {
  ...
  client.query('SELECT * FROM notifymeusers WHERE username=$1',[req.body.username], function(err,result){
    if (err) {
